import svgPaths from "./svg-xi28pp7cj2";
...
export default function Saved() {
  return (
    <div className="bg-gradient-to-b from-[#e2edf0] relative size-full to-[#e9f3f7] to-[72.117%]" data-name="Saved">
      <Frame />
      <Frame2 />
      <div className="absolute bg-[#0f345e] content-stretch flex h-[58px] items-center justify-center left-[26px] overflow-clip px-[32px] py-[16px] rounded-[12px] top-[519px] w-[349px]" data-name="save button">
