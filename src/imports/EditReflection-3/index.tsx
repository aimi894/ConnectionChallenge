import svgPaths from "./svg-do21csr0vy";
...
function Frame1() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex h-[79px] items-center overflow-clip py-[12px] relative rounded-[10px] shrink-0 w-full" data-name="Frame">
      <Frame2 />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold items-start justify-between leading-[normal] not-italic relative shrink-0 text-[12.5px] w-full whitespace-nowrap">
      <p className="relative shrink-0 text-[#3b82c4]">Change</p>
      <p className="relative shrink-0 text-[#c0392b]">Remove</p>
    </div>
  );
}
