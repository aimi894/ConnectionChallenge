import svgPaths from "./svg-0po2ey3j50";
...
function Descrition() {
  return (
    <div className="content-stretch flex items-start overflow-clip px-[8px] relative shrink-0 w-[376px]" data-name="Descrition">
...
function IntroSection() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center overflow-clip py-[12px] relative shrink-0 w-[402px]" data-name="Intro_section">
      <PhotoAndWelcoming />
      <div className="bg-white content-stretch flex flex-col gap-[16px] items-start p-[12px] relative rounded-[20px] shrink-0 w-[362px]" data-name="challenge card">
        <Frame1 />
        <Descrition />
      </div>
    </div>
