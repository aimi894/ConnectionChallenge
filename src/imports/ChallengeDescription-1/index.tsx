import svgPaths from "./svg-qhxxrgr8p";
    ...
    <div className="bg-[#f2f8f4] relative rounded-[12px] shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="[word-break:break-word] content-stretch flex font-normal gap-[10px] items-center leading-[1.45] not-italic p-[14px] relative size-full">
          <p className="font-['Inter:Regular','Noto_Sans_Symbols2:Regular',sans-serif] h-[20px] relative shrink-0 text-[#2f8f52] text-[15px] w-[19px]">✎</p>
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] min-w-px relative text-[#39403b] text-[14px]">{`When you're done, you'll add a short reflection.`}</p>
        </div>
      </div>
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[14px] h-[840px] items-start left-[21px] top-[130px] w-[360px]" data-name="Frame">
      <Frame2 />
