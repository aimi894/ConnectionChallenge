import svgPaths from "./svg-lqagmfm6vb";
  ...
  return (
    <div className="absolute inset-[8.33%]" data-name="Layer 93">
      <svg className="absolute block inset-0 size-full" fill="none" height="26.6667" preserveAspectRatio="none" viewBox="0 0 26.6667 26.6667" width="26.6667">
        <g id="Layer 93">
          <path d={svgPaths.peef7880} fill="var(--fill-0, white)" fillOpacity="0.6" id="Vector" />
          <path d={svgPaths.pc43dd80} fill="var(--fill-0, white)" fillOpacity="0.6" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
