import svgPaths from "./svg-ry7zs80rd3";
...
function Frame7() {
  return (
    <div className="bg-white h-[50px] relative rounded-[12px] shrink-0 w-full" data-name="Frame">
...
function Frame10() {
  return (
    <div className="bg-white h-[100px] relative rounded-[12px] shrink-0 w-full" data-name="Frame">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-[14px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#a7adb8] text-[15px] w-[324px]">{`Describe what you'll do and why it matters to you…`}</p>
        </div>
      </div>
      <div aria-hidden className="absolute border-[#dfe4ea] border-[1.5px] border-solid inset-0 pointer-events-none rounded-[12px]" />
    </div>
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[21px] overflow-clip top-[132px] w-[360px]" data-name="Frame">
...
export default function WriteYourOwnChallenge() {
  return (
    <div className="bg-gradient-to-b from-[#e2edf0] relative size-full to-[#e9f3f7] to-[72%]" data-name="Write your own challenge">
      ...
      <Frame />
      <p className="[word-break:break-word] absolute font-['Montaga:Regular',sans-serif] leading-[normal] left-[70px] not-italic text-[#0f3460] text-[24px] top-[70px] w-[165px]">Write your own</p>
      <Frame1 />
      <SaveButton />
    </div>
  );
