import svgPaths from "./svg-xi7oyrpahj";
...
function Question() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[24px] py-[4px] top-[456px] w-[363px]" data-name="question 1">
...
function Question1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[24px] px-[10px] py-[12px] rounded-[10px] top-[612px] w-[363px]" data-name="question 2">
...
function Question2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[322px] items-start left-[24px] px-[10px] py-[12px] top-[784px]" data-name="question 3">
