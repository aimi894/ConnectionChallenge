import svgPaths from "./svg-t98uldgz70";
...
function Title() {
  return (
    <div className="content-stretch flex items-center justify-between overflow-clip relative shrink-0 w-[205px]" data-name="Title">
      <p className="[word-break:break-word] font-['Montaga:Regular',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#777a89] text-[14px] w-[211px]">{`Volunteer at an Animal Rescue `}</p>
    </div>
  );
}
...
function ActivityTitle() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[3px] items-start min-w-px not-italic overflow-clip relative text-[12px]" data-name="activity title">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.32] relative shrink-0 text-[#777a89] w-[145px]">Beginner tennis meetup</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#4a4a4a] w-[164px]">Sat 10:00 AM · in your area</p>
    </div>
  );
}
...
function ActivityTitle1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[3px] items-start min-w-px not-italic overflow-clip relative" data-name="activity title">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.32] relative shrink-0 text-[#777a89] text-[12.5px] w-[145px]">Community book club</p>
