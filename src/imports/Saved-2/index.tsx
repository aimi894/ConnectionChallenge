import svgPaths from "./svg-q5qmrm6qhm";

function Frame1() {
  return (
    <div className="bg-[#eafaef] relative rounded-[100px] shrink-0 size-[88px]" data-name="Frame">
      ...
      <div aria-hidden className="absolute border-2 border-[#3aa25a] border-solid inset-0 pointer-events-none rounded-[100px]" />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] h-[170px] items-center left-[44px] overflow-clip top-[250px] w-[314px]" data-name="Frame">
      <Frame1 />
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.35] min-w-full not-italic relative shrink-0 text-[#777a89] text-[20px] text-center w-[min-content]">Reflection saved</p>
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.35] min-w-full not-italic relative shrink-0 text-[#4a4a4a] text-[16px] text-center w-[min-content]">{`Nice — that's another real-world win!`}</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start leading-[1.35] min-w-px not-italic overflow-clip relative text-[#777a89]" data-name="Frame">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold relative shrink-0 text-[16px] w-[194px]">Saved as ‘Community’</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[14px] w-[171px]">{`It's now on your calendar.`}</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="absolute bg-[rgba(226,237,240,0.2)] content-stretch flex gap-[10px] items-center left-[60px] overflow-clip p-[14px] rounded-[10px] top-[445px] w-[282px]" data-name="Frame">
...
export default function Saved() {
  return (
    <div className="bg-gradient-to-b from-[#e2edf0] relative size-full to-[#e9f3f7] to-[72.117%]" data-name="Saved">
      <Frame />
      <Frame2 />
      <div className="absolute bg-[#0f345e] content-stretch flex h-[58px] items-center justify-center left-[27px] overflow-clip px-[32px] py-[16px] rounded-[12px] top-[599px] w-[349px]" data-name="save button">
