import svgPaths from "./svg-2h0tbczhwe";
...
function Frame2() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex gap-[7px] items-center overflow-clip px-[12px] py-[7px] relative rounded-[16px] shrink-0" data-name="Frame">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] not-italic relative shrink-0 text-[#232327] text-[14px] w-[79px]">Community</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-[16px] shrink-0" data-name="Frame">
      <div className="content-stretch flex gap-[7px] items-center overflow-clip px-[12px] py-[7px] relative rounded-[inherit] size-full">
        <div className="relative shrink-0 size-[11px]" data-name="Ellipse">
          <svg className="absolute block inset-0 size-full" fill="none" height="11" preserveAspectRatio="none" viewBox="0 0 11 11" width="11">
            <circle cx="5.5" cy="5.5" fill="var(--fill-0, #3B82C4)" id="Ellipse" r="5.5" />
          </svg>
        </div>
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#232327] text-[14px] w-[40px]">Social</p>
      </div>
      <div aria-hidden className="absolute border-[#dfe4ea] border-[1.2px] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-[16px] shrink-0" data-name="Frame">
      <div className="content-stretch flex gap-[7px] items-center overflow-clip px-[12px] py-[7px] relative rounded-[inherit] size-full">
        ...
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#232327] text-[14px] w-[29px]">Solo</p>
      </div>
      <div aria-hidden className="absolute border-[#dfe4ea] border-[1.2px] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-[16px] shrink-0" data-name="Frame">
      <div className="content-stretch flex gap-[7px] items-center overflow-clip px-[12px] py-[7px] relative rounded-[inherit] size-full">
        ...
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#232327] text-[14px] w-[55px]">Outdoor</p>
      </div>
      <div aria-hidden className="absolute border-[#dfe4ea] border-[1.2px] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
...
function Category() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Category">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] not-italic relative shrink-0 text-[#777a89] text-[16px] w-full">Category</p>
      <Frame1 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Frame">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g clipPath="url(#clip0_2_965)" id="Frame">
          <circle cx="10" cy="10" id="Ellipse" r="9" stroke="var(--stroke-0, #0F345E)" strokeWidth="2" />
          <circle cx="10" cy="10" fill="var(--fill-0, #0F345E)" id="Ellipse_2" r="5" />
        </g>
        <defs>
...
function Frame6() {
  return (
    <div className="bg-white content-stretch flex gap-[12px] items-center overflow-clip px-[16px] py-[15px] relative rounded-[14px] shrink-0 w-full" data-name="Frame">
      <Frame7 />
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] min-w-px not-italic relative text-[#777a89] text-[15px]">Volunteer at an animal rescue or shelter</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Frame">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g clipPath="url(#clip0_2_969)" id="Frame">
          <circle cx="10" cy="10" id="Ellipse" r="9" stroke="var(--stroke-0, #C8CCD4)" strokeWidth="2" />
        </g>
        <defs>
...
function Frame8() {
  return (
    <div className="bg-white relative rounded-[14px] shrink-0 w-full" data-name="Frame">
      <div className="content-stretch flex gap-[12px] items-center overflow-clip px-[16px] py-[15px] relative rounded-[inherit] size-full">
        <Frame9 />
        <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.4] min-w-px not-italic relative text-[#4a4a4a] text-[15px]">Say hi to someone new at school</p>
      </div>
      <div aria-hidden className="absolute border-[#e3e7ee] border-[1.2px] border-solid inset-0 pointer-events-none rounded-[14px]" />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="bg-white relative rounded-[14px] shrink-0 w-full" data-name="Frame">
      <div className="content-stretch flex gap-[12px] items-center overflow-clip px-[16px] py-[15px] relative rounded-[inherit] size-full">
        <Frame11 />
        <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.4] min-w-px not-italic relative text-[#4a4a4a] text-[15px]">Spend an afternoon reading in a park</p>
      </div>
      <div aria-hidden className="absolute border-[#e3e7ee] border-[1.2px] border-solid inset-0 pointer-events-none rounded-[14px]" />
    </div>
  );
...
function Frame12() {
  return (
    <div className="relative rounded-[14px] shrink-0 w-full" data-name="Frame">
      <div className="[word-break:break-word] content-stretch flex gap-[8px] items-center leading-[1.4] not-italic overflow-clip px-[16px] py-[14px] relative rounded-[inherit] size-full text-[#777a89]">
        <p className="font-['Inter:Semi_Bold','Noto_Sans_JP:Bold',sans-serif] font-semibold relative shrink-0 text-[16px] w-[17px]">＋</p>
        <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal min-w-px relative text-[15px]">Write your own challenge</p>
      </div>
      <div aria-hidden className="absolute border-[#b7bcc6] border-[1.5px] border-dashed inset-0 pointer-events-none rounded-[14px]" />
    </div>
  );
}
...
function Challenge() {
  return (
    <div className="content-stretch flex flex-col gap-[13px] items-start relative shrink-0 w-full" data-name="Challenge">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] not-italic relative shrink-0 text-[#777a89] text-[16px] w-full">Choose a challenge</p>
      <Frame6 />
      <Frame8 />
      <Frame10 />
      <Frame12 />
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[13px] items-start left-[21px] overflow-clip top-[130px] w-[360px]" data-name="Frame">
      <Category />
      <Challenge />
    </div>
  );
...
function SaveButton({ className }: { className?: string }) {
  return (
    <div className={className || "absolute bottom-0 h-[247px] left-[26px] pointer-events-none top-[627px]"}>
  ...
  return (
    <div className="bg-white relative rounded-[20px] shrink-0 size-[40px]" data-name="Frame">
      <div className="content-stretch flex items-center justify-center overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#0f3460] text-[20px] w-[8px]">‹</p>
      </div>
...
function NewChallenge1() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[18px] top-[64px]" data-name="New Challenge">
      <Frame13 />
      <p className="[word-break:break-word] font-['Montaga:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0f3460] text-[24px] w-[154px]">New challenge</p>
    </div>
  );
}
...
export default function NewChallenge() {
  return (
    <div className="bg-gradient-to-b from-[#e2edf0] relative size-full to-[#e9f3f7] to-[72%]" data-name="New challenge">
