import svgPaths from "./svg-515z3h6wiq";
...
function Title() {
  return (
    <div className="content-stretch flex items-center overflow-clip relative shrink-0 w-[372px]" data-name="Title">
      <p className="[word-break:break-word] font-['Montaga:Regular',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#0f3460] text-[16px] w-[372px] whitespace-pre-wrap">{`Volunteer at an Animal  Rescue Shelter`}</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[372px]">
      <Title />
    </div>
  );
}
...
function Descrition() {
  return (
    <div className="content-stretch flex items-start overflow-clip relative shrink-0 w-[376px]" data-name="Descrition">
      <div className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#4a4a4f] text-[14px] whitespace-nowrap">
        <p className="leading-[1.5] mb-0 whitespace-pre">{`Spend an afternoon helping out at a local animal `}</p>
        <p className="leading-[1.5] mb-0 whitespace-pre">{`shelter — walking dogs, cleaning, or  just keeping `}</p>
        <p className="leading-[1.5] whitespace-pre">the animals company.</p>
      </div>
    </div>
  );
}
...
function IntroSection() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center overflow-clip pb-[20px] pt-[12px] relative shrink-0 w-[402px]" data-name="Intro_section">
      <PhotoAndWelcoming />
      <div className="bg-white content-stretch drop-shadow-[0px_4px_2px_rgba(0,0,0,0.25)] flex flex-col gap-[16px] items-start px-[12px] py-[20px] relative rounded-[20px] shrink-0 w-[362px]" data-name="challenge card">
        <Frame1 />
        <Descrition />
      </div>
    </div>
...
function Frame() {
  return (
    <div className="h-[70px] overflow-clip relative shrink-0 w-full" data-name="Frame">
      <div className="absolute bg-[#3aa25a] h-[66px] left-[44px] rounded-[3px] top-[4px] w-[30px]" data-name="Rectangle" />
      <div className="absolute bg-[#3b82c4] h-[45px] left-[104px] rounded-[3px] top-[25px] w-[30px]" data-name="Rectangle" />
      <div className="absolute bg-[#d6379b] h-[26px] left-[164px] rounded-[3px] top-[44px] w-[30px]" data-name="Rectangle" />
      <div className="absolute bg-[#e8973a] h-[48px] left-[224px] rounded-[3px] top-[22px] w-[30px]" data-name="Rectangle" />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center overflow-clip relative shrink-0" data-name="Frame">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.32] not-italic relative shrink-0 text-[#4a4a4a] text-[12px] w-[66px]">Community</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[4px] items-center overflow-clip relative shrink-0" data-name="Frame">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.32] not-italic relative shrink-0 text-[#4a4a4a] text-[12px] w-[34px]">Social</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[4px] items-center overflow-clip relative shrink-0" data-name="Frame">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.32] not-italic relative shrink-0 text-[#4a4a4a] text-[12px] w-[28px]">Solo</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[4px] items-center overflow-clip relative shrink-0" data-name="Frame">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.32] not-italic relative shrink-0 text-[#4a4a4a] text-[12px] w-[51px]">Outdoor</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[12px] items-start overflow-clip px-[20px] relative shrink-0 w-[314px]" data-name="Frame">
      <Frame3 />
      <Frame4 />
      <Frame5 />
      <Frame6 />
...
function YourProgress() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[12px] h-[155px] items-start overflow-clip p-[10px] relative rounded-[10px] shrink-0 w-full" data-name="Your Progress">
...
function ActivityTitle() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[3px] items-start min-w-px not-italic overflow-clip relative" data-name="activity title">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.32] min-w-full relative shrink-0 text-[#777a89] text-[16px] w-[min-content]">Beginner tennis meetup</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#4a4a4a] text-[12px] w-[164px]">Sat 10:00 AM · in your area</p>
    </div>
  );
}
...
function ActivityTitle1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[3px] items-start min-w-px not-italic overflow-clip relative" data-name="activity title">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.32] min-w-full relative shrink-0 text-[#777a89] text-[16px] w-[min-content]">Community book club</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#6b6b70] text-[12px] w-[164px]">Thu 6:00 PM · 0.4 mi away</p>
    </div>
  );
}
...
function Activities1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start px-[24px] relative shrink-0 w-full" data-name="Activities">
      <div className="bg-white content-stretch flex gap-[10px] h-[97px] items-center overflow-clip p-[12px] relative rounded-[10px] shrink-0 w-[362px]" data-name="activity">
        <ColourCode />
        <ActivityTitle />
      ...
      <div className="bg-white content-stretch flex gap-[10px] h-[66px] items-center overflow-clip p-[12px] relative rounded-[10px] shrink-0 w-[362px]" data-name="activity">
        <ColourCode1 />
        <ActivityTitle1 />
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.32] not-italic relative shrink-0 text-[#6b6b70] text-[18px] w-[7px]">›</p>
      </div>
...
export default function Dashboard() {
  return (
    <div className="bg-gradient-to-b from-[#e2edf0] relative size-full to-[#e9f3f7] to-[72.117%]" data-name="Dashboard">
      ...
      <div className="absolute bg-[rgba(0,0,0,0)] content-stretch flex gap-[20px] h-[72px] items-center left-[4px] overflow-clip px-[24px] py-[12px] rounded-[40px] top-[769px]" data-name="menu">
        <Dashboard1 />
        <Calendar />
        <Add />
        <Settings />
