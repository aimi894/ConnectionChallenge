import svgPaths from "./svg-wgwh48p6w3";
...
function Question() {
  return (
    <div className="content-stretch flex flex-col h-[149px] items-start px-[10px] py-[12px] relative rounded-[10px] shrink-0 w-full" data-name="question 2">
...
function Question2() {
  return (
    <div className="content-stretch flex flex-col h-[172px] items-start px-[10px] py-[12px] relative rounded-[10px] shrink-0 w-full" data-name="question 4">
