import svgPaths from "./svg-5ko239upm7";
...
function ListOfQuestions() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] h-[956px] items-start relative shrink-0 w-[363px]" data-name="List of questions">
      <Question />
      <Question1 />
      <Question2 />
      <Question3 />
...
function Completed2() {
  return (
    <div className="relative rounded-[12px] shrink-0" data-name="Completed">
