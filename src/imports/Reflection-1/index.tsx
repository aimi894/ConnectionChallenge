import svgPaths from "./svg-0ptrb78inq";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-0 overflow-clip px-[24px] py-[12px] top-[58px] w-[402px]" data-name="Frame">
      ...
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.35] min-w-px not-italic relative text-[#4a4a4a] text-[16px]">Sat · Jul 25</p>
...
function Frame4() {
  return (
    <div className="bg-[#eafaef] relative rounded-[12px] shrink-0" data-name="Frame">
      <div className="content-stretch flex items-start overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
    ...
    <div className="flex-[1_0_0] min-w-px relative" data-name="Frame">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[6px] items-start p-[12px] relative size-full">
          <Frame3 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.35] not-italic relative shrink-0 text-[#4a4a4a] text-[12px] w-[114px]">Community · Easy</p>
        </div>
      </div>
    </div>
  );
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold h-[22px] leading-[1.35] not-italic relative shrink-0 text-[#232327] text-[12.5px] w-full">Photo</p>
      <Frame5 />
    </div>
  );
}
...
function InputField() {
  return (
    <div className="bg-[rgba(0,0,0,0)] h-[47px] relative rounded-[6px] shrink-0 w-full" data-name="Input field">
      <div className="overflow-clip rounded-[inherit] size-full">
...
function Question() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[20px] py-[4px] top-[437px] w-[363px]" data-name="question 1">
...
function InputField1() {
  return (
    <div className="bg-[rgba(0,0,0,0)] h-[88px] relative rounded-[6px] shrink-0 w-full" data-name="Input field">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-[10px] relative size-full">
...
function Question1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[20px] py-[4px] top-[549px] w-[363px]" data-name="question 2">
...
function InputFiels() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex flex-col h-[88px] items-start opacity-88 overflow-clip p-[10px] relative rounded-[6px] shrink-0 w-[363px]" data-name="Input fiels">
...
function Question2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[20px] top-[717px]" data-name="question 3">
