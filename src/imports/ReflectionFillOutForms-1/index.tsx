import svgPaths from "./svg-wtbsg0q30o";
...
function ListOfQuestions() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[956px] items-start py-[8px] relative shrink-0 w-[364px]" data-name="List of questions">
      <Question />
      <Question1 />
      <Question2 />
      <Question3 />
