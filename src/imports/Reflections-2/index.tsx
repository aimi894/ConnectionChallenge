import svgPaths from "./svg-2zbt9bg15s";
...
function Question4() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start overflow-clip py-[12px] relative shrink-0 w-full" data-name="question 5">
      <Question5 />
...
function ListOfQuestions() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[950px] items-start py-[8px] relative shrink-0 w-[364px]" data-name="List of questions">
      <Question />
      <Question1 />
      <Question2 />
      <Question3 />
