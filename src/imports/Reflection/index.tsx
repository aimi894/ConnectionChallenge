import svgPaths from "./svg-c4dzae26ut";
...
function Question() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[18px] py-[4px] top-[437px] w-[363px]" data-name="question 1">
...
function Question1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[20px] py-[4px] top-[583px] w-[363px]" data-name="question 2">
...
function Question2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[20px] top-[754px]" data-name="question 3">
