import svgPaths from "./svg-htfpe7kcow";
  ...
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[223px]" data-name="Challenges">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] not-italic opacity-88 relative shrink-0 text-[#777a89] text-[0px] text-center w-[225px]">
        <span className="font-['Montaga:Regular',sans-serif] leading-[1.35] text-[20px]">
          Volunteer at an
          <br aria-hidden />
    ...
    <div className="bg-white h-[88px] relative rounded-[6px] shrink-0 w-full" data-name="Input field">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-[10px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.35] not-italic relative shrink-0 text-[#777a89] text-[16px] w-[169px]">Type your answer…</p>
        </div>
      </div>
    </div>
  );
...
function InputField1() {
  return (
    <div className="bg-white h-[88px] relative rounded-[6px] shrink-0 w-full" data-name="Input field">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-[10px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.35] not-italic relative shrink-0 text-[#b3b3b8] text-[12px] w-[153px]">Type your answer…</p>
        </div>
      </div>
    </div>
  );
...
function InputFiels() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[88px] items-start opacity-88 overflow-clip p-[10px] relative rounded-[6px] shrink-0 w-[363px]" data-name="Input fiels">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.35] not-italic relative shrink-0 text-[#777a89] text-[12px] w-[134px]">Type your answer…</p>
    </div>
  );
}
...
function Question5() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] h-[162px] items-start overflow-clip py-[4px] relative shrink-0 w-full" data-name="question 7">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold h-[57px] leading-[1.35] min-w-full not-italic relative shrink-0 text-[#232327] text-[16px] w-[min-content]">On scale 1 to 5 how much did it reinforce your confidence</p>
...
function ListOfQuestions() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] h-[960px] items-start py-[8px] relative shrink-0 w-[363px]" data-name="List of questions">
      <Question />
      <Question1 />
      <Question2 />
      <Question3 />
...
function Upload() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center py-[12px] relative shrink-0" data-name="upload">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.35] not-italic relative shrink-0 text-[#4a4a4a] text-[12px] w-[193px]">JPEG, PNG, and PDF up to 50 MB.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[12px] shrink-0 w-[161px]" data-name="Browse file button">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[12px] py-[8px] relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.35] not-italic relative shrink-0 text-[12px] text-black whitespace-nowrap">Browse File</p>
      </div>
...
function Questions() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[1355px] items-center left-[5px] overflow-x-auto overflow-y-clip pb-[80px] px-[20px] top-[206px] w-[397px]" data-name="Questions">
      <ListOfQuestions />
      <div className="bg-[#f5f6f4] relative rounded-[8px] shrink-0 w-[357px]" data-name="Add Photo">
